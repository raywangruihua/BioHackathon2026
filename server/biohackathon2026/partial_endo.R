...
# LOAD DATA
# -----------------------------
endo_df <- read.csv("partial_endometriosis_data.csv", stringsAsFactors = FALSE)
...
xgb.save(final_model, "partial_endo_xgboost_tuned.json")
saveRDS(feature_cols, "partial_endo_feature_names.rds")
saveRDS(best_params,  "partial_endo_best_params.rds")
saveRDS(best_nrounds, "partial_endo_best_nrounds.rds")
