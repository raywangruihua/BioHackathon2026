...
saveRDS(pca_result, "partial_pcos_pca_model.rds")
saveRDS(colnames(numeric_clean), "partial_pcos_feature_names.rds")
...
saveRDS(n_pcs, "partial_pcos_n_pcs.rds")
...
# SAVE MODEL
# -----------------------------
xgb.save(xgb_model, "partial_pcos_xgboost_model.json")
